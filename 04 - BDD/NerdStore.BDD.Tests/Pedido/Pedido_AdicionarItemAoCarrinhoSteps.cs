...
namespace NerdStore.BDD.Tests.Pedido
{
    ...
    public class Pedido_AdicionarItemAoCarrinhoSteps
    {
        ...
        [When(@"O usuario acionar uma unidade ao carrinho")]
        public void QuandoOUsuarioAcionarUmaUnidadeAoCarrinho()
        {
            ScenarioContext.Current.Pending();
        }
        ...
        [Then(@"O usuário será redirecionado ao resume da compra")]
        public void EntaoOUsuarioSeraRedirecionadoAoResumeDaCompra()
        {
            ScenarioContext.Current.Pending();
        }
